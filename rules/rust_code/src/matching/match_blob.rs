...
// /// A struct holding the matching data in a single array.
// /// This saves on dereferences, and will allow Rekeying quickly.
// ///
// /// The matchblob stores its data as a sorted array.
// #[pyclass]
// #[derive(Debug, Clone)]
// pub struct MatchingBlob {
...
// impl MatchingBlob {
//     pub fn as_ref(&self) -> BlobRef {
//         BlobRef {
//             keys: &self.keys,
//             data: &self.data,
//         }
//     }
//     pub fn as_ref_mut(&mut self) -> BlobRefMut {
//         BlobRefMut {
//             keys: &mut self.keys,
//             data: &mut self.data,
//         }
...
// /// A view on the data of the blob.
// struct BlobRef<'t> {
//     keys: &'t [i64],
//     data: &'t [i64],
// }

// impl<'t> Index<usize> for BlobRef<'t> {
//     type Output = [i64];

//     fn index(&self, index: usize) -> &Self::Output {
//         &self.data[index * self.keys.len()..(index + 1) * self.keys.len()]
//     }
// }
...
// impl<'t> Index<usize> for BlobRefMut<'t> {
//     type Output = [i64];
...
// impl<'t> IndexMut<usize> for BlobRefMut<'t> {
//     fn index_mut(&mut self, index: usize) -> &mut Self::Output {
//         &mut self.data[index * self.keys.len()..(index + 1) * self.keys.len()]
//     }
// }
...
//     use crate::matching_hash::MatchingHash;
