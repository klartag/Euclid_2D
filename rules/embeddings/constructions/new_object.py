...
def new_point() -> EmbeddedPoint:
    ...
    generated uniformly in a circle of radius 10 around the origin.
    """
...
def new_line() -> EmbeddedLine:
    """
    Returns a line passing through two randomly generated points.
    """
    return EmbeddedLine(new_point(), new_point())

def new_circle() -> EmbeddedCircle:
    """
    Returns a circle with a randomly generated point and radius.
    """
