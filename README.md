...
The full list of construction functions can be found in
[rules/constructions_and_predicates/constructions_database.yml](rules/constructions_and_predicates/constructions_database.yml).
...
A mostly complete list of predicate functions can be found in
[rules/constructions_and_predicates/predicates_database.yml](rules/constructions_and_predicates/predicates_database.yml).
The format in which that file is written is described [further down in this document](#configuration-predicates).

The rest of the predicates (the more unusual ones) are defined under the directory
[rules/predicates/implementations](rules/predicates/implementations).
